...
class ActivitySupportPage extends StatefulWidget {
  static const String id = 'ActivitySupportPage';

  @override
  _ActivitySupportPageState createState() => _ActivitySupportPageState();
}

class _ActivitySupportPageState extends State<ActivitySupportPage> {
  ...
  Future _getActivity() async {
    ...
    try {
      _activity = await BookingNetworking().getRecentActivity(params);
    } catch (e) {
      print('gg wtf');
      // print(e.toString());
    } finally {
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          GestureDetector(
                            onTap: (){
                              Navigator.pushNamed(context, ActivitySupportAllPage.id);
                            },
                            child: Text(
                              'View All',
