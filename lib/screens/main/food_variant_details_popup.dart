...
import 'package:haloapp/components_new/shop_item_info_card.dart';
...
class DonationFoodVariantDetailsPopup extends StatefulWidget {
  DonationFoodVariantDetailsPopup({
    @required this.food,
    @required this.shop,
  ...
  @override
  _DonationFoodVariantDetailsPopupState createState() =>
      _DonationFoodVariantDetailsPopupState();
}

class _DonationFoodVariantDetailsPopupState
    extends State<DonationFoodVariantDetailsPopup> {
...
//        print('variant.variantMin ${variant.variantMin}');
  ...
  void addFoodToCart() {
    ...
    // if (items.length < 1) {
    //   items.add(FoodVariantItemModel(variantId: ''));
    // }
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: InputTextField(
                          hintText:
                              AppTranslations.of(context).text('eg_less_ice'),
                          onChange: (value) {
                            _remarkInput = value;
                          },
